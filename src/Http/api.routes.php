...
Route::prefix('accounting')->group(
    function () {
        ...
        Route::prefix('account-partner-logs')->group(
            function () {
                Route::get('/', 'AccountPartnerLogs\AccountPartnerLogsController@index');
                Route::get('/actions', 'AccountPartnerLogs\AccountPartnerLogsController@getActions');

                Route::get('{accounting_account_partner_logs}/tags ', 'AccountPartnerLogs\AccountPartnerLogsController@tags');
                Route::post('{accounting_account_partner_logs}/tags ', 'AccountPartnerLogs\AccountPartnerLogsController@saveTags');
                Route::get('{accounting_account_partner_logs}/addresses ', 'AccountPartnerLogs\AccountPartnerLogsController@addresses');
                Route::post('{accounting_account_partner_logs}/addresses ', 'AccountPartnerLogs\AccountPartnerLogsController@saveAddresses');

                Route::get('/{accounting_account_partner_logs}/{subObjects}', 'AccountPartnerLogs\AccountPartnerLogsController@relatedObjects');
                Route::get('/{accounting_account_partner_logs}', 'AccountPartnerLogs\AccountPartnerLogsController@show');

                Route::post('/', 'AccountPartnerLogs\AccountPartnerLogsController@store');
                Route::post('/{accounting_account_partner_logs}/do/{action}', 'AccountPartnerLogs\AccountPartnerLogsController@doAction');

                Route::patch('/{accounting_account_partner_logs}', 'AccountPartnerLogs\AccountPartnerLogsController@update');
                Route::delete('/{accounting_account_partner_logs}', 'AccountPartnerLogs\AccountPartnerLogsController@destroy');
            }
        );
