 ...
 */
class AbstractInvoiceItemsPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(InvoiceItemsPerspective $model)
    {
    ...
    public function includeActions(InvoiceItemsPerspective $model)
    {
    ...
    public function includeMedia(InvoiceItemsPerspective $model)
    {
    ...
    public function includeSocialMedia(InvoiceItemsPerspective $model)
    {
    ...
    public function includeComments(InvoiceItemsPerspective $model)
    {
    ...
    public function includeVotes(InvoiceItemsPerspective $model)
    {
    ...
    public function includeMeta(InvoiceItemsPerspective $model)
    {
    ...
    public function includePhoneNumbers(InvoiceItemsPerspective $model)
    {
    ...
    public function includeAddresses(InvoiceItemsPerspective $model)
    {
