...
class AbstractAffiliatesPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeActions(AffiliatesPerspective $model)
    {
    ...
    public function includeMedia(AffiliatesPerspective $model)
    {
    ...
    public function includeSocialMedia(AffiliatesPerspective $model)
    {
    ...
    public function includeComments(AffiliatesPerspective $model)
    {
    ...
    public function includeVotes(AffiliatesPerspective $model)
    {
    ...
    public function includeMeta(AffiliatesPerspective $model)
    {
    ...
    public function includePhoneNumbers(AffiliatesPerspective $model)
    {
    ...
    public function includeAddresses(AffiliatesPerspective $model)
    {
