...
class AbstractWeeklyPaidInvoicesPerformanceTransformer extends AbstractTransformer
{
    ...
    public function includeActions(WeeklyPaidInvoicesPerformance $model)
    {
    ...
    public function includeMedia(WeeklyPaidInvoicesPerformance $model)
    {
    ...
    public function includeSocialMedia(WeeklyPaidInvoicesPerformance $model)
    {
    ...
    public function includeComments(WeeklyPaidInvoicesPerformance $model)
    {
    ...
    public function includeVotes(WeeklyPaidInvoicesPerformance $model)
    {
    ...
    public function includeMeta(WeeklyPaidInvoicesPerformance $model)
    {
    ...
    public function includePhoneNumbers(WeeklyPaidInvoicesPerformance $model)
    {
    ...
    public function includeAddresses(WeeklyPaidInvoicesPerformance $model)
    {
