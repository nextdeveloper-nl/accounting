 ...
 */
class AbstractIntegratorsPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(IntegratorsPerspective $model)
    {
    ...
    public function includeActions(IntegratorsPerspective $model)
    {
    ...
    public function includeMedia(IntegratorsPerspective $model)
    {
    ...
    public function includeSocialMedia(IntegratorsPerspective $model)
    {
    ...
    public function includeComments(IntegratorsPerspective $model)
    {
    ...
    public function includeVotes(IntegratorsPerspective $model)
    {
    ...
    public function includeMeta(IntegratorsPerspective $model)
    {
    ...
    public function includePhoneNumbers(IntegratorsPerspective $model)
    {
    ...
    public function includeAddresses(IntegratorsPerspective $model)
    {
