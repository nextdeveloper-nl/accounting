 ...
 */
class AbstractVendorsPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(VendorsPerspective $model)
    {
    ...
    public function includeActions(VendorsPerspective $model)
    {
    ...
    public function includeMedia(VendorsPerspective $model)
    {
    ...
    public function includeSocialMedia(VendorsPerspective $model)
    {
    ...
    public function includeComments(VendorsPerspective $model)
    {
    ...
    public function includeVotes(VendorsPerspective $model)
    {
    ...
    public function includeMeta(VendorsPerspective $model)
    {
    ...
    public function includePhoneNumbers(VendorsPerspective $model)
    {
    ...
    public function includeAddresses(VendorsPerspective $model)
    {
