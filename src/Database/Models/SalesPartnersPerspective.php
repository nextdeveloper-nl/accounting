...
use NextDeveloper\Accounting\Database\Observers\SalesPartnersPerspectiveObserver;
...
/**
 * SalesPartnersPerspective model.
 *
 ...
 */
class SalesPartnersPerspective extends Model
{
    ...
    protected $table = 'accounting_sales_partners_perspective';
    ...
    public static function boot()
    {
        ...
        parent::observe(SalesPartnersPerspectiveObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('accounting.scopes.accounting_sales_partners_perspective');
