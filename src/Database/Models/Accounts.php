...
class Accounts extends Model
{
    ...
    public function partnerAssignments(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(\NextDeveloper\Accounting\Database\Models\PartnerAssignments::class);
    }
