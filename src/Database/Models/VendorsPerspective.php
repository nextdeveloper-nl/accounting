...
use NextDeveloper\Accounting\Database\Observers\VendorsPerspectiveObserver;
 ...
 */
class VendorsPerspective extends Model
{
    ...
    protected $table = 'accounting_vendors_perspective';
    ...
    public static function boot()
    {
        ...
        parent::observe(VendorsPerspectiveObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('accounting.scopes.accounting_vendors_perspective');
