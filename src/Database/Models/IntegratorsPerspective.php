...
use NextDeveloper\Accounting\Database\Observers\IntegratorsPerspectiveObserver;
 ...
 */
class IntegratorsPerspective extends Model
{
    ...
    protected $table = 'accounting_integrators_perspective';
    ...
    public static function boot()
    {
        ...
        parent::observe(IntegratorsPerspectiveObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('accounting.scopes.accounting_integrators_perspective');
