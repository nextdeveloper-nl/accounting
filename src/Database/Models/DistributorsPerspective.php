...
use NextDeveloper\Accounting\Database\Observers\DistributorsPerspectiveObserver;
...
class DistributorsPerspective extends Model
{
    ...
    protected $table = 'accounting_distributors_perspective';
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('accounting.scopes.accounting_distributors_perspective');
