...
class AccountsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Accounting\Accounts', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\Accounting\Accounts', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Accounting\Accounts', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Accounting\Accounts', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\Accounting\Accounts', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Accounting\Accounts', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Accounting\Accounts', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Accounting\Accounts', $model);
    }
