...
class PromoCodesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Accounting\PromoCodes', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Accounting\PromoCodes', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Accounting\PromoCodes', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Accounting\PromoCodes', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Accounting\PromoCodes', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Accounting\PromoCodes', $model);
    }
