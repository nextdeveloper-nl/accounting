...
class InvoiceItemsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Accounting\InvoiceItems', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Accounting\InvoiceItems', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Accounting\InvoiceItems', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Accounting\InvoiceItems', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Accounting\InvoiceItems', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Accounting\InvoiceItems', $model);
    }
