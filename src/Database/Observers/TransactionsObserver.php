...
class TransactionsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Accounting\Transactions', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Accounting\Transactions', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Accounting\Transactions', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Accounting\Transactions', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Accounting\Transactions', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Accounting\Transactions', $model);
    }
