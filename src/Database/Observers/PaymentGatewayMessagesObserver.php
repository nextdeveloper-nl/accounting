...
/**
 * Class PaymentGatewayMessagesObserver
 *
...
class PaymentGatewayMessagesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Accounting\PaymentGatewayMessages', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Accounting\PaymentGatewayMessages', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Accounting\PaymentGatewayMessages', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Accounting\PaymentGatewayMessages', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Accounting\PaymentGatewayMessages', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Accounting\PaymentGatewayMessages', $model);
    }
