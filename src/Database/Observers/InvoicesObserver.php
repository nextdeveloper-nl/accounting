...
class InvoicesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Accounting\Invoices', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Accounting\Invoices', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Accounting\Invoices', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Accounting\Invoices', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Accounting\Invoices', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Accounting\Invoices', $model);
    }
