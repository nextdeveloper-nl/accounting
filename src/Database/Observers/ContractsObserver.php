...
class ContractsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Accounting\Contracts', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\Accounting\Contracts', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Accounting\Contracts', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Accounting\Contracts', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\Accounting\Contracts', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\Accounting\Contracts', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Accounting\Contracts', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\Accounting\Contracts', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Accounting\Contracts', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Accounting\Contracts', $model);
    }
