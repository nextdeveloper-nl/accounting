...
/**
 * This class is responsible from managing the data for ContractItemsPerspective
 *
 * Class ContractItemsPerspectiveService.
 *
 * @package NextDeveloper\Accounting\Database\Models
 */
class AbstractContractItemsPerspectiveService
{
    public static function get(?ContractItemsPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ContractItemsPerspectiveQueryFilter($request);
        }
        ...
        $model = ContractItemsPerspective::filter($filter);
    ...
    {
        return ContractItemsPerspective::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?ContractItemsPerspective
    {
        return ContractItemsPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = ContractItemsPerspective::class;
    ...
    {
        $object = ContractItemsPerspective::where('uuid', $objectId)->first();

        if(!$object) {
            throw new ModelNotFoundException('Cannot find the ContractItemsPerspective object with the id: ' . $objectId);
        }

        $availableAction = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\Accounting\ContractItemsPerspective')
            ->first();

        if(!$availableAction) {
            throw new NotFoundException('Cannot find the action "' . $action . '" for NextDeveloper\Accounting\ContractItemsPerspective.');
        }
     ...
     *
     * @param  $id
     * @return ContractItemsPerspective|null
     */
    public static function getById($id) : ?ContractItemsPerspective
    {
        return ContractItemsPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = ContractItemsPerspective::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = ContractItemsPerspective::create($data);
        } catch(\Exception $e) {
            throw $e;
        }
     ...
     *
     * @param  array $data
     * @return ContractItemsPerspective
     */
    public static function updateRaw(array $data) : ?ContractItemsPerspective
    {
    ...
    {
        $model = ContractItemsPerspective::where('uuid', $id)->first();
