...
/**
* This class is responsible from managing the data for CreditTransactions
*
* Class CreditTransactionsService.
*
* @package NextDeveloper\Accounting\Database\Models
*/
class AbstractCreditTransactionsService {
    public static function get(CreditTransactionsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator {
        ...
        */
        if($filter == null)
            $filter = new CreditTransactionsQueryFilter($request);
        ...
        $model = CreditTransactions::filter($filter);
    ...
    * @return mixed
    */
    public static function getByRef($ref) : ?CreditTransactions {
        return CreditTransactions::findByRef($ref);
    }

    public static function getActions()
    {
        $model = CreditTransactions::class;
    ...
    */
    ...
    {
        $object = CreditTransactions::where('uuid', $objectId)->first();

        if(!$object) {
            throw new ModelNotFoundException('Cannot find the CreditTransactions object with the id: ' . $objectId);
        }

        $availableAction = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\Accounting\CreditTransactions')
            ->first();

        if(!$availableAction) {
            throw new NotFoundException('Cannot find the action "' . $action . '" for NextDeveloper\Accounting\CreditTransactions.');
        }
    ...
    *
    * @param $id
    * @return CreditTransactions|null
    */
    public static function getById($id) : ?CreditTransactions {
        return CreditTransactions::where('id', $id)->first();
    }
    ...
    */
    public static function relatedObjects($uuid, $object) {
        try {
            $obj = CreditTransactions::where('uuid', $uuid)->first();
    ...
    */
    public static function create(array $data) {
        ...
        try {
            $model = CreditTransactions::create($data);
        } catch(\Exception $e) {
            throw $e;
        }
    ...
    */
    public static function updateRaw(array $data) : ?CreditTransactions
    {
    ...
    */
    public static function update($id, array $data) {
        $model = CreditTransactions::where('uuid', $id)->first();
