...
class AbstractPromoCodesService
{
    public static function get(?PromoCodesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new PromoCodesQueryFilter($request);
        }
    ...
    public static function doAction($objectId, $action, ...$params)
    {
        ...
        if(!$object) {
            throw new ModelNotFoundException('Cannot find the PromoCodes object with the id: ' . $objectId);
        }
        ...
        if(!$availableAction) {
            throw new NotFoundException('Cannot find the action "' . $action . '" for NextDeveloper\Accounting\PromoCodes.');
        }
