...
/**
 * This class is responsible from managing the data for AffiliatesPerspective
 *
 * Class AffiliatesPerspectiveService.
 *
 * @package NextDeveloper\Accounting\Database\Models
 */
class AbstractAffiliatesPerspectiveService
{
    public static function get(?AffiliatesPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new AffiliatesPerspectiveQueryFilter($request);
        }
        ...
        $model = AffiliatesPerspective::filter($filter);
    ...
    {
        return AffiliatesPerspective::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?AffiliatesPerspective
    {
        return AffiliatesPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = AffiliatesPerspective::class;
    ...
    {
        $object = AffiliatesPerspective::where('uuid', $objectId)->first();

        if(!$object) {
            throw new ModelNotFoundException('Cannot find the AffiliatesPerspective object with the id: ' . $objectId);
        }

        $availableAction = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\Accounting\AffiliatesPerspective')
            ->first();

        if(!$availableAction) {
            throw new NotFoundException('Cannot find the action "' . $action . '" for NextDeveloper\Accounting\AffiliatesPerspective.');
        }
     ...
     *
     * @param  $id
     * @return AffiliatesPerspective|null
     */
    public static function getById($id) : ?AffiliatesPerspective
    {
        return AffiliatesPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = AffiliatesPerspective::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = AffiliatesPerspective::create($data);
        } catch(\Exception $e) {
            throw $e;
        }
     ...
     *
     * @param  array $data
     * @return AffiliatesPerspective
     */
    public static function updateRaw(array $data) : ?AffiliatesPerspective
    {
    ...
    {
        $model = AffiliatesPerspective::where('uuid', $id)->first();
