...
class AbstractPartnerAssignmentsService
{
    ...
    public static function doAction($objectId, $action, ...$params)
    {
        ...
        if(!$object) {
            throw new ModelNotFoundException('Cannot find the PartnerAssignments object with the id: ' . $objectId);
        }
        ...
        if(!$availableAction) {
            throw new NotFoundException('Cannot find the action "' . $action . '" for NextDeveloper\Accounting\PartnerAssignments.');
        }
