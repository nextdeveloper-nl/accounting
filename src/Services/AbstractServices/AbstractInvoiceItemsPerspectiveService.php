 ...
 */
class AbstractInvoiceItemsPerspectiveService
{
    public static function get(?InvoiceItemsPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new InvoiceItemsPerspectiveQueryFilter($request);
        }
    ...
    {
        return InvoiceItemsPerspective::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?InvoiceItemsPerspective
    {
        return InvoiceItemsPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = InvoiceItemsPerspective::class;
    ...
    {
        $object = InvoiceItemsPerspective::where('uuid', $objectId)->first();

        if(!$object) {
            throw new ModelNotFoundException('Cannot find the InvoiceItemsPerspective object with the id: ' . $objectId);
        }

        $availableAction = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\Accounting\InvoiceItemsPerspective')
            ->first();

        if(!$availableAction) {
            throw new NotFoundException('Cannot find the action "' . $action . '" for NextDeveloper\Accounting\InvoiceItemsPerspective.');
        }
     ...
     *
     * @param  $id
     * @return InvoiceItemsPerspective|null
     */
    public static function getById($id) : ?InvoiceItemsPerspective
    {
        return InvoiceItemsPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = InvoiceItemsPerspective::where('uuid', $uuid)->first();
     ...
     *
     * @param  array $data
     * @return InvoiceItemsPerspective
     */
    public static function updateRaw(array $data) : ?InvoiceItemsPerspective
    {
    ...
    {
        $model = InvoiceItemsPerspective::where('uuid', $id)->first();
