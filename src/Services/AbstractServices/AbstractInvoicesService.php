...
class AbstractInvoicesService
{
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Invoices
    {
     ...
     */
    public static function getById($id) : ?Invoices
    {
    ...
    {
        try {
            $obj = Invoices::where('uuid', $uuid)->first();
     ...
     * @return Invoices
     */
    public static function updateRaw(array $data) : ?Invoices
    {
